...
<br>
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              foreach ($expedientes_pedagogia as $e){
              ?>
              <tr>
            <td ><?php echo $e->no_expediente;?></td>
              ...
              <td><?php echo $e->nombre_centro;?></td>
                ...
                <td><center><a class="btn btn-info" href="<?php echo base_url('index.php/proyecto/valoracion_pedagogica_sin_estatus');?>/<?php echo $e->id_expediente;?>/<?php echo $e->id_ingreso;?>" role="button"><span class="glyphicon glyphicon-plus-sign"></span></span></a></td>
                <td><center><a class="btn btn-danger" href="<?php echo base_url('index.php/proyecto/valoraciones_pedag_todas');?>/<?php echo $e->id_expediente;?>/<?php echo $e->id_ingreso;?>" role="button"><span class="glyphicon glyphicon-eye-open"></span> <span class="glyphicon glyphicon-file"></span></span></a></td>
              </tr>
              <?php 
              }
              ?>
    ...
    <!--<td><center><a class="btn btn-success" href="<?php echo base_url('index.php/proyecto/ver_valoracion_ped');?>/<?php echo $e->id_expediente;?>/<?php echo $e->id_ingreso;?>" role="button"><span class="glyphicon glyphicon-eye-open"></span></span></a></td>
    <td><center><a class="btn btn-warning" href="<?php echo base_url('index.php/proyecto/editar_valoracion_ped');?>/<?php echo $e->id_expediente;?>/<?php echo $e->id_ingreso;?>" role="button"><span class="glyphicon glyphicon-pencil"></span></span></a></td>-->
