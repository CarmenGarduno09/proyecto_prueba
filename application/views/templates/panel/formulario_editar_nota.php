<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <ol class="breadcrumb">
      ...
      <li class="active">Edición de Notas psicológicas</li>
    </ol>

       <center> <h1 class="page-header">EDITAR NOTA PSICOLÓGICA</h1> </center>
 ...
 <input type="hidden" name="expediente" value="<?php echo $expediente['id_expediente']; ?>">
      ...
      <input type="hidden" name="expediente" value="<?php echo $notitas['id_nota']; ?>">
      <?php echo form_error('id_nota');?>
...
<div class="panel panel-primary">
    <div class="panel-body">
     ...
     <?php
        //echo validation_errors();
        $atributos = array('class'=>'form-horizontal');
        echo form_open('proyecto/editar_nota/'.$notitas['id_nota'],$atributos);
        //var_dump($privilegio);
       ?>
 <input type="hidden" name="expediente" value="<?php echo $expediente['id_expediente']; ?>">
      <?php echo form_error('id_expediente');?>
 ...
 <label for="actividad">Nombre de la actividad:<span style="color: red" class="asterisco">*</span></label>
        <input  type="text" name="actividad" value="<?php if(set_value('actividad')) echo (set_value('actividad'));else if(form_error('actividad')){echo " ";}else{ echo $notitas['actividad'];};?>" id="actividad" class="form-control" placeholder="Actividad" >
...
<label>Fecha: <span style="color: red" class="asterisco">*</span></label>
        ...
        <input type="date" name="fecha_n" value="<?php if(set_value('fecha_n')) echo (set_value('fecha_n'));else if(form_error('fecha_n')){echo " ";}else{ echo $notitas['fecha_n'];};?>" id="id_nota" class="form-control"
    step="1"
    min="1900-01-01"      
...
<center><label for="coment">COMENTARIOS</span></label></center>
        <input  type="text" name="coment" value="<?php if(set_value('coment')) echo (set_value('coment'));else if(form_error('coment')){echo " ";}else{ echo $notitas['coment'];} ;?>" id="coment" class="form-control" placeholder="Describa sus cometarios ">
