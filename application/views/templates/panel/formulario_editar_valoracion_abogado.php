...
<div class="panel panel-primary">
  ...
  <center> <h2 class="page-header">VALORACIÓN DE INGRESO DEL MENOR</h2> </center>
    <!-- <?php 
       ...
       echo form_open('proyecto/editar_valoracion_abogado/'.$expediente['id_expediente'],$atributos);?>-->
       ...
       <!-- Cuestionario 0 -->
        <div class="panel panel-primary">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-11">
                        ...
                        <?php echo form_error('registro');?></div>
            ...
            <div class="panel-body" style="display:none;" id="preguntas">
                      ...
                      <label for="verificar">Está registrado en el registro civil:</label><br>
                          ...
                          <input type="text" class="form-control" name="registro_text" id="otro_text"     value="<?php if(set_value('registro_text')) echo set_value('registro_text'); else{if($valoracion_juridica) echo $valoracion_juridica['registro_civil'];}?>" <?php if(($valoracion_juridica['registro_civil']=='SI') || ($valoracion_juridica['registro_civil']=='NO') ){ echo "disabled='disabled'";}?>><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-11">
                        Derecho a vivir en familia<span style="color: red" class="asterisco"> *</span><?php echo form_error('vive_edit');?><?php echo form_error('convivencia_edit');?><?php echo form_error('opinion_edit');?><?php echo form_error('separado_edit');?>
                        </div>
            ...
            <label>La NNA vive con su familia, salvo que la autoridad competente haya determinado lo contrario<span style="color: red" class="asterisco"> *</span></label><br>
                    ...
                    <input type="radio" name="convivencia" id="otro2"  onclick="enable_fields_otro2();" value="OTRO"  <?php  if(($valoracion_juridica['convivencia_fam']!='SI') and ($valoracion_juridica['convivencia_fam']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control"  name="convivencia_text" id="otro_text2"    value="<?php if(set_value('convivencia_text')) echo set_value('convivencia_text'); else{if($valoracion_juridica) echo $valoracion_juridica['convivencia_fam'];}?>" <?php if(($valoracion_juridica['convivencia_fam']=='SI') || ($valoracion_juridica['convivencia_fam']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
                    ...
                    <input type="radio" name="fam_extensa" id="otro5"  onclick="enable_fields_otro5();" value="OTRO"  <?php  if(($valoracion_juridica['fam_extensa']!='SI') and ($valoracion_juridica['fam_extensa']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" name="fam_extensa_text" id="otro_text5"  value="<?php if(set_value('fam_extensa_text')) echo set_value('fam_extensa_text'); else{if($valoracion_juridica) echo $valoracion_juridica['fam_extensa'];}?>" <?php if(($valoracion_juridica['fam_extensa']=='SI') || ($valoracion_juridica['fam_extensa']=='NO') ){ echo "disabled='disabled' ";}?> placeholder="Otra opción"><br>
                  		 <br>
            ...
            <div class="panel-body" style="display:none;" id="preguntas2">
                   ...
                   <input type="radio" name="derechos" value="SI"  id="si_registro6" onclick="disable_fields6()" <?php if($valoracion_juridica['derecho']=='SI') echo "checked";?>> SI <br>
                    ...
                    <input type="radio" name="derechos" id="otro6"  onclick="enable_fields_otro6();" value="OTRO"   <?php  if(($valoracion_juridica['derecho']!='SI') and ($valoracion_juridica['derecho']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" name="derechos_text_edit" id="otro_text6"  value="<?php if(set_value('derechos_text_edit')) echo set_value('derechos_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['derecho'];}?>" <?php if(($valoracion_juridica['derecho']=='SI') || ($valoracion_juridica['derecho']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas3">
                    ...
                    <input type="radio" name="discriminacion" id="otro7"  onclick="enable_fields_otro7();" value="OTRO"  <?php  if(($valoracion_juridica['discriminacion']!='SI') and ($valoracion_juridica['discriminacion']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control"  name="discriminacion_text_edit" id="otro_text7"  value="<?php if(set_value('discriminacion_text_edit')) echo set_value('discriminacion_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['discriminacion'];}?>" <?php if(($valoracion_juridica['discriminacion']=='SI') || ($valoracion_juridica['discriminacion']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas4">
                    ...
                    <input type="radio" name="vivienda" id="otro8"  onclick="enable_fields_otro8();" value="OTRO"  <?php  if(($valoracion_juridica['vivienda']!='SI') and ($valoracion_juridica['vivienda']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="vivienda_text_edit" id="otro_text8"  value="<?php if(set_value('vivienda_text_edit')) echo set_value('vivienda_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['vivienda'];}?>" <?php if(($valoracion_juridica['vivienda']=='SI') || ($valoracion_juridica['vivienda']=='NO') ){ echo "disabled='disabled' ";}?> placeholder="Otra opción"><br>
                    ...
                    <input type="radio" name="proteccion" id="otro9"  onclick="enable_fields_otro9();" value="OTRO"  <?php  if(($valoracion_juridica['proteccion']!='SI') and ($valoracion_juridica['proteccion']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="proteccion_text_edit" id="otro_text9"  value="<?php if(set_value('proteccion_text_edit')) echo set_value('proteccion_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['proteccion'];}?>" <?php if(($valoracion_juridica['proteccion']=='SI') || ($valoracion_juridica['proteccion']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas5">
                    ...
                    <input type="radio" name="violencia" id="otro10"  onclick="enable_fields_otro10();" value="OTRO"  <?php  if(($valoracion_juridica['violencia']!='SI') and ($valoracion_juridica['violencia']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="violencia_text_edit" id="otro_text10"  value="<?php if(set_value('violencia_text_edit')) echo set_value('violencia_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['violencia'];}?>" <?php if(($valoracion_juridica['violencia']=='SI') || ($valoracion_juridica['violencia']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <label>La NNA vive con su familia, salvo que la autoridad competente haya determinado lo contrario<span style="color: red" class="asterisco"> *</span></label><br>
                    ...
                    <input type="radio" name="vive" id="no_registro1" onclick="disable_fields1()" value="NO" <?php if($valoracion_juridica['vive_familia']=='NO') echo "checked";?>> NO <br>
                     <input type="radio" name="vive" id="otro1"  onclick="enable_fields_otro1();" value="OTRO"  <?php if(($valoracion_juridica['vive_familia']!='SI') and ($valoracion_juridica['vive_familia']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" name="vive_text_edit" id="otro_text1"   value="<?php if(set_value('vive_text_edit')) echo set_value('vive_text'); else{if($valoracion_juridica) echo $valoracion_juridica['vive_familia'];}?>" <?php if(($valoracion_juridica['vive_familia']=='SI') || ($valoracion_juridica['vive_familia']=='NO') ){ echo "disabled='disabled' ";}?>  palceholder="Otra opción"><br>
                  		<br><?php echo form_error('vive');?>
                    ...
                    <input type="radio" name="nutricion" id="otro12"  onclick="enable_fields_otro12();" value="OTRO"  <?php  if(($valoracion_juridica['nutricion']!='SI') and ($valoracion_juridica['nutricion']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="nutricion_text_edit" id="otro_text12"  value="<?php if(set_value('nutricion_text_edit')) echo set_value('nutricion_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['nutricion'];}?>" <?php if(($valoracion_juridica['nutricion']=='SI') || ($valoracion_juridica['nutricion']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
                    ...
                    <input type="radio" name="revision" id="otro13"  onclick="enable_fields_otro13();" value="OTRO"  <?php  if(($valoracion_juridica['revision_med']!='SI') and ($valoracion_juridica['revision_med']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="revision_text_Edit" id="otro_text13" value="<?php if(set_value('revision_text_Edit')) echo set_value('revision_text_Edit'); else{if($valoracion_juridica) echo $valoracion_juridica['revision_med'];}?>" <?php if(($valoracion_juridica['revision_med']=='SI') || ($valoracion_juridica['revision_med']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
                    ...
                    <input type="radio" name="cartilla" id="otro14"  onclick="enable_fields_otro14();" value="OTRO"  <?php  if(($valoracion_juridica['cartilla']!='SI') and ($valoracion_juridica['cartilla']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="cartilla_text_edit" id="otro_text14"  value="<?php if(set_value('cartilla_text_edit')) echo set_value('cartilla_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['cartilla'];}?>" <?php if(($valoracion_juridica['cartilla']=='SI') || ($valoracion_juridica['cartilla']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
                    ...
                    <input type="radio" name="tratamiento" id="otro15"  onclick="enable_fields_otro15();" value="OTRO"  <?php  if(($valoracion_juridica['tratamiento_enf']!='SI') and ($valoracion_juridica['tratamiento_enf']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="tratamiento_text_edit" id="otro_text15"  value="<?php if(set_value('tratamiento_text_edit')) echo set_value('tratamiento_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['tratamiento_enf'];}?>" <?php if(($valoracion_juridica['tratamiento_enf']=='SI') || ($valoracion_juridica['tratamiento_enf']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas7">
                    ...
                    <input type="radio" name="atencion_dis" id="otro16"  onclick="enable_fields_otro16();" value="OTRO"  <?php  if(($valoracion_juridica['atencion_discr']!='SI') and ($valoracion_juridica['atencion_discr']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="atencion_dis_text_edit" id="otro_text16"  value="<?php if(set_value('atencion_dis_text_edit')) echo set_value('atencion_dis_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['atencion_discr'];}?>" <?php if(($valoracion_juridica['atencion_discr']=='SI') || ($valoracion_juridica['atencion_discr']=='NO') ){ echo "disabled='disabled' ";}?>  placeholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas8">
                    ...
                    <input type="radio" name="escuela" id="otro17"  onclick="enable_fields_otro17();" value="OTRO"  <?php  if(($valoracion_juridica['inscrito_esc']!='SI') and ($valoracion_juridica['inscrito_esc']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="escuela_text_edit" id="otro_text17" value="<?php if(set_value('escuela_text_edit')) echo set_value('escuela_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['inscrito_esc'];}?>" <?php if(($valoracion_juridica['inscrito_esc']=='SI') || ($valoracion_juridica['inscrito_esc']=='NO') ){ echo "disabled='disabled' ";}?>    palceholder="Otra opción"><br>
                    ...
                    <input type="radio" name="asiste_reg" id="otro18"  onclick="enable_fields_otro18();" value="OTRO"  <?php  if(($valoracion_juridica['asiste_reg']!='SI') and ($valoracion_juridica['asiste_reg']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="asiste_reg_text_edit" id="otro_text18"  value="<?php if(set_value('asiste_reg_text_edit')) echo set_value('asiste_reg_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['asiste_reg'];}?>" <?php if(($valoracion_juridica['asiste_reg']=='SI') || ($valoracion_juridica['asiste_reg']=='NO') ){ echo "disabled='disabled' ";}?>   palceholder="Otra opción"><br>
                    ...
                    <input type="radio" name="duerme" id="otro19"  onclick="enable_fields_otro19();" value="OTRO"  <?php  if(($valoracion_juridica['duerme']!='SI') and ($valoracion_juridica['duerme']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="duerme_text_edit" id="otro_text19"  value="<?php if(set_value('duerme_text_edit')) echo set_value('duerme_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['duerme'];}?>" <?php if(($valoracion_juridica['duerme']=='SI') || ($valoracion_juridica['duerme']=='NO') ){ echo "disabled='disabled' ";}?>  palceholder="Otra opción"><br>
                    ...
                    <input type="radio" name="act_espar" id="otro20"  onclick="enable_fields_otro20();" value="OTRO"  <?php  if(($valoracion_juridica['act_esparcimiento']!='SI') and ($valoracion_juridica['act_esparcimiento']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="act_espar_text_edit" id="otro_text20"  value="<?php if(set_value('act_espar_text_edit')) echo set_value('act_espar_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['act_esparcimiento'];}?>" <?php if(($valoracion_juridica['act_esparcimiento']=='SI') || ($valoracion_juridica['act_esparcimiento']=='NO') ){ echo "disabled='disabled' ";}?>  palceholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas9">
                    ...
                    <input type="radio" name="intimidad" id="otro21"  onclick="enable_fields_otro21();" value="OTRO"  <?php  if(($valoracion_juridica['intimidad']!='SI') and ($valoracion_juridica['intimidad']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="intimidad_text_edit" id="otro_text21"  value="<?php if(set_value('intimidad_text_edit')) echo set_value('intimidad_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['intimidad'];}?>" <?php if(($valoracion_juridica['intimidad']=='SI') || ($valoracion_juridica['intimidad']=='NO') ){ echo "disabled='disabled' ";}?>   palceholder="Otra opción"><br>
                    ...
                    <input type="radio" name="privacidad" id="otro22"  onclick="enable_fields_otro22();" value="OTRO"  <?php  if(($valoracion_juridica['privacidad']!='SI') and ($valoracion_juridica['privacidad']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="privacidad_text_edit" id="otro_text22" value="<?php if(set_value('privacidad_text_edit')) echo set_value('privacidad_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['privacidad'];}?>" <?php if(($valoracion_juridica['privacidad']=='SI') || ($valoracion_juridica['privacidad']=='NO') ){ echo "disabled='disabled' ";}?>   palceholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas10">
                    ...
                    <input type="radio" name="accion" id="otro23"  onclick="enable_fields_otro23();" value="OTRO"  <?php  if(($valoracion_juridica['accion']!='SI') and ($valoracion_juridica['accion']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="accion_text_edit" id="otro_text23"  value="<?php if(set_value('accion_text_edit')) echo set_value('accion_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['accion'];}?>" <?php if(($valoracion_juridica['accion']=='SI') || ($valoracion_juridica['accion']=='NO') ){ echo "disabled='disabled' ";}?>  palceholder="Otra opción"><br>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body" style="display:none;" id="preguntas11">
                    ...
                    <input type="radio" name="opinion_n" id="otro24"  onclick="enable_fields_otro24();" value="OTRO"  <?php  if(($valoracion_juridica['opinion_n']!='SI') and ($valoracion_juridica['opinion_n']!='NO') ){ echo "checked";}?>> <b>Otro </b>
                          <input type="text" class="form-control" disable="disabled" name="opinion_n_text_edit" id="otro_text24"  value="<?php if(set_value('opinion_n_text_edit')) echo set_value('opinion_n_text_edit'); else{if($valoracion_juridica) echo $valoracion_juridica['opinion_n'];}?>" <?php if(($valoracion_juridica['opinion_n']=='SI') || ($valoracion_juridica['opinion_n']=='NO') ){ echo "disabled='disabled' ";}?>   palceholder="Otra opción"><br>
